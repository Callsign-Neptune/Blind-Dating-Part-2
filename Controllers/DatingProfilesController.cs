...
namespace BlindDating.Controllers
{
    public class DatingProfilesController : Controller
    {
        ...
        public DatingProfilesController(BlindDatingContext context, UserManager<IdentityUser> userManager, IHostingEnvironment _webroot)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,DisplayName,Firstname,Lastname,Age,Gender,Bio,UserAccountId")] DatingProfile datingProfile, IFormFile FilePhoto)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DisplayName,Firstname,Lastname,Age,Gender,Bio,UserAccountId")] DatingProfile datingProfile, IFormFile FilePhoto)
        {
